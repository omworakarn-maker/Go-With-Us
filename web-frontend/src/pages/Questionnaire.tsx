...
const QUESTIONS: AnyQuestion[] = [
    {
        ...
        lowLabel: 'ประหยัด (Budget) - เน้นคุ้มค่า โฮสเทล (100-500฿)',
        midLabel: 'ปานกลาง (Standard) - โรงแรมทั่วไป สบายๆ (500-2000฿)',
        highLabel: 'หรูหรา (Luxury) - รีสอร์ทห้าดาว ดินเนอร์หรู (2000฿+)',
    },
    {
        type: 'rating',
        key: 'activityStyle',
